...
namespace OmegaSudoku
{
    class Solver
    {
        ...
        {
            byte[,] matrix = MakeCoverMatrix.createCoverMat(initialMatrix, schemeInt); //this function creates the cover matrix which is a matrix that represents
            ...
            ColumnNode doubleLinkedList = MakeDoubleLinkedList.createDoubleLinkedLists(matrix, schemeInt);   // create the circular doubly-linked toroidal list from the cover matrix
